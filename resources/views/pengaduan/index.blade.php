            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="flex justify-center items-center">
                    ...
                    <table class="table table-lg table-auto w-11/12 px-6 bg-white text-black dark:bg-gray-900 dark:text-white ">
                        ...
                        <tr>
                            <td colspan="8" class="border-2 px-2 text-center">Anda belum memiliki pengaduan. </td>
                        </tr>
                        @else
                        ...
                        <tr>
                            ...
                            <td class="border-2 px-2"></td>
                            <td class="border-2 px-2">
                                <form action="{{ route('edit-laporan', ['id_pengaduan' => $pengaduan->id_pengaduan]) }}" method="get">
                                ...
                                <form  id="deleteForm" action="{{ route('hapus-laporan', ['id_pengaduan' => $pengaduan->id_pengaduan]) }}" method="post">
                                    @csrf
                                    @method('delete')
