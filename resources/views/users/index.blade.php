...
<div class="flex max-w-7xl mx-auto">
    ...
    <div class="py-12">
        <div class="sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                <div class="p-6 text-gray-900 dark:text-gray-100 flex justify-between items-center no-print">
                    {{ __("Semua Pengguna") }}
                ...
                @endpush
                <button id="print" class="flex items-center rounded-md bg-blue-400 my-1 p-2 hover:bg-blue-800">
