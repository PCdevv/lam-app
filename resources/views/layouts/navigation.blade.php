<nav x-data="{ open: false }" class="no-print bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('laporan-saya')" :active="request()->routeIs('laporan-saya')">
                        {{ __('Laporan Saya') }}
                    </x-nav-link>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('tulis-laporan')" :active="request()->routeIs('tulis-laporan')">
                {{ __('Tulis Laporan') }}
            </x-responsive-nav-link>
        </div>
